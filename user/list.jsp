...
=======
                	<img id="preview-photo" style="float:left;" src="/JiancaiHome/resources/admin/easyui/images/user_photo.jpg" width="100px">
>>>>>>> 建材之家
...
=======
                <td><input type="text" id="add-photo" name="photo" value="/JiancaiHome/resources/admin/easyui/images/user_photo.jpg" readonly="readonly" class="wu-text " /></td>
>>>>>>> 建材之家
            </tr>
            <tr>
...
=======
                	<img id="edit-preview-photo" style="float:left;" src="/JiancaiHome/resources/admin/easyui/images/user_photo.jpg" width="100px">
>>>>>>> 建材之家
                	<a style="float:left;margin-top:40px;" href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-upload" onclick="uploadPhoto()" plain="true">上传图片</a>
                </td>
            </tr>
...
=======
                <td><input type="text" id="edit-photo" name="photo" value="/JiancaiHome/resources/admin/easyui/images/user_photo.jpg" readonly="readonly" class="wu-text " /></td>
>>>>>>> 建材之家
            </tr>
            <tr>
                <td width="60" align="right">用户名:</td>
