...
<div class="easyui-panel" title="编辑建材" style="width:1200px;height:800px;">
	<div style="padding:0px">
		<form id="edit-form" method="post">
	        <input type="hidden" name="id" value="${product.id }">
	        <table cellspacing="15">
	            <tr>
	                <td width="60" align="right">建材分类:</td>
	                <td >
	            ...
	            <tr>
	                <td width="60" align="right">建材标题:</td>
	                <td ><input type="text" name="name" value="${product.name }" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写建材标题'" /></td>
	            </tr>
	            <tr>
	                <td width="60" align="right">建材主图:</td>
	                <td>
	            ...
	            <tr>
	                <td width="60" align="right">建材价格:</td>
	                <td><input type="text" name="price" value="${product.price }" class="wu-text easyui-numberbox easyui-validatebox" data-options="required:true,min:0,precision:2, missingMessage:'请填写建材价格'" /></td>
	            </tr>
	            <tr>
	                <td width="60" align="right">建材库存:</td>
	                <td ><input type="text" name="stock" value="${product.stock }" class="wu-text easyui-numberbox easyui-validatebox" data-options="required:true,min:0,precision:0, missingMessage:'请填写建材库存'" /></td>
	            </tr>
	            <tr>
