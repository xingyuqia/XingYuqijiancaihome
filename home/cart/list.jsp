...
<div class="shop_gwc_bd clearfix">
		...
		<!-- 购物车为空 -->
			...
			<div class="empty_cart mb10">
				<div class="message">
					<p>购物车内暂时没有建材，您可以<a href="../home/index">去首页</a>挑选喜欢的建材</p>
				</div>
			</div>
			</c:if>
		<!-- 购物车为空 end-->
		...
		<div class="shop_gwc_bd_contents clearfix">
			...
			<table style="font-size:12px;">
				...
				<tfoot>
					<tr>
						<td colspan="6">
							<div class="gwc_foot_zongjia">建材总价(不含运费)<span>￥<strong id="good_zongjia">0.00</strong></span></div>
							<div class="clear"></div>
