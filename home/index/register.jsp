...
<body>
	...
	<div class="main">
		...
		<div class="login-form-left fl">
			<dl class="func clearfix">
				<dt>注册之后您可以</dt>
				<dd class="ico05"><i></i>购买建材支付订单</dd>
				<dd class="ico01"><i></i>查看各类销售建材</dd>
				<dd class="ico03"><i></i>空间好友推送分享</dd>
				<dd class="ico02"><i></i>收藏建材关注建材</dd>
				<dd class="ico06"><i></i>建材资讯服务评价</dd>
	...
	<div class="footer clear wrap1000">
		<p> <a href="/JiancaiHome">首页</a> | <a href="">招聘英才</a> | <a href="">广告合作</a> | <a href="http://programmer.ischoolbar.com">关于建材之家</a> | <a href="">联系我们</a></p>
		<p>Copyright 2016-2020 建材之家 Inc.,All rights reserved.</p>
	</div>
</body>
<script>
	function changeCode(){
