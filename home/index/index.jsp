                      ...
                      <div id="xifan_bd1lfimg" style="width:780px;height:350px;">
                        <div >
                          <dl class="" style="width:780px;height:350px;">
                            <dt><a href="" title="" target="_blank"><img width="780px" height="360px" src="../resources/home/images/shou.png" alt="德技优品门窗"></a></dt>
                            <dd><h2><a href="" target="_blank">德技优品门窗</a></h2></dd>
                          </dl>
                          <dl class="" style="width:780px;height:350px;">
                            <dt><a href="" title="" target="_blank"><img width="780px" height="360px" src="../resources/home/images/shou1.png" alt="中国.厦门国际会展中心"></a></dt>
                            <dd><h2><a href="" target="_blank">中国.厦门国际会展中心</a></h2></dd>
                          </dl>
                          <dl class="" style="width:780px;height:350px;">
                            <dt><a href="" title="" target="_blank"><img width="780px" height="360px" src="../resources/home/images/shou2.png" alt="福享天下多功能粘接剂"></a></dt>
                            <dd><h2><a href="" target="_blank">福享天下多功能粘接剂</a></h2></dd>
                          </dl>
                          <dl class="" style="width:780px;height:350px;">
                            <dt><a href="" title="" target="_blank"><img width="780px" height="360px" src="../resources/home/images/shou3.png" alt="上精品 增流量"></a></dt>
                            <dd><h2><a href="" target="_blank">上精品 增流量</a></h2></dd>
                          </dl>
                        </div>
                      </div>
                    </div>
                        ...
                        <ul>
                            ...
                            <li style="width:158px;height:190px;">
                                <dl>
                                    ...
                                    <dd>建材城价：<em>${product.price }</em>元</dd>
                                </dl>
                            </li>
                            </c:forEach>
                        </ul>
