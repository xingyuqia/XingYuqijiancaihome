		...
		<div class="shop_bd_list_right clearfix">
			...
			<div class="sort-bar">
				<div class="bar-l"> 
		            ...
		            <!-- 排序方式S -->
		            <ul class="array">
		              <li class="selected"><a title="默认排序" class="nobg" href="../product/search?search_content=${search_content }&priceMin=${priceMin}&priceMax=${priceMax}&page=${page}">默认</a></li>
		              <li><a title="点击按销量从高到低排序"  href="../product/search?search_content=${search_content }&orderby=sellNum&priceMin=${priceMin}&priceMax=${priceMax}&page=${page}">销量</a></li>
		              <li><a title="点击按人气从高到低排序"  href="../product/search?search_content=${search_content }&orderby=viewNum&priceMin=${priceMin}&priceMax=${priceMax}&page=${page}">人气</a></li>
		              <li><a title="点击按价格从高到低排序"  href="../product/search?search_content=${search_content }&orderby=price&priceMin=${priceMin}&priceMax=${priceMax}&page=${page}">价格</a></li>
		            </ul>
		            <!-- 排序方式E --> 
		            <!-- 价格段S -->
