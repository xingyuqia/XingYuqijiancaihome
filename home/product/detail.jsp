...
<div class="shop_goods_bd clear">
			...
			<div class="shop_goods_show_right">
				<ul>
					...
					<li style="padding:20px 0;">
						...
						<span><a href="javascript:void(0)" id="add-favorite-btn" pid="${product.id }" class="goods_sub_gou" >收藏该建材</a></span>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="shop_goods_bd_xiangqing clearfix">
			<div class="shop_goods_bd_xiangqing_tab">
				<ul>
					<li id="xiangqing_tab_1" onmouseover="shop_goods_easytabs('1', '1');" onfocus="shop_goods_easytabs('1', '1');" onclick="return false;"><a href=""><span>建材详情</span></a></li>
					<li id="xiangqing_tab_2" onmouseover="shop_goods_easytabs('1', '2');" onfocus="shop_goods_easytabs('1', '2');" onclick="return false;"><a href=""><span>建材评论</span></a></li>
				</ul>
			</div>
