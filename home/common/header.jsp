...
<body>
	...
	<div class="shop_hd">
		...
		<div class="shop_hd_topNav">
			<div class="shop_hd_topNav_all">
				...
				<div class="shop_hd_topNav_all_left">
					<p>您好，欢迎来到<b><a href="/JiancaiHome">建材之家</a></b>
					...
					<ul class="topNav_quick_menu">
						...
						<li>
							<div class="topNav_menu">
								<a href="#" class="topNavHover">我的建材城<i></i></a>
								<div class="topNav_menu_bd" style="display:none;" >
						            <ul>
						              <li><a title="已买到的建材"href="../order/list">已买到的建材</a></li>
						...
						<li>
							<div class="topNav_menu">
								...
								<div class="topNav_menu_bd" style="display:none;">
						            <ul>
						              <li><a title="收藏的建材" target="_top" href="../favorite/list">收藏的建材</a></li>
						            </ul>
						        </div>
							</div>
						</li>
		...
		<div class="shop_hd_header">
			<div class="shop_hd_header_logo"><h1 class="logo"><a href="/JiancaiHome"><img src="../resources/home/images/logo.png" alt="ShopCZ" /></a><span>建材之家</span></h1></div>
			<div class="shop_hd_header_search">
                            <ul class="shop_hd_header_search_tab">
			        <li id="search" class="current">建材</li>
		...
		<div class="shop_hd_menu">
			...
			<div class="shop_hd_menu_all_category ${allCategoryClass }" id="${allCategoryId }"><!-- 首页去掉 id="shop_hd_menu_all_category" 加上clsss shop_hd_menu_hover -->
				<div class="shop_hd_menu_all_category_title"><h2 title="所有建材分类"><a href="javascript:void(0);">所有建材分类</a></h2><i></i></div>
			...
			<ul class="shop_hd_menu_nav">
				<li class="${currentHome }link"><a href="/JiancaiHome"><span>首页</span></a></li>
