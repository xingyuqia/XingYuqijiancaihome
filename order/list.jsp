...
<div id="view-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:600px;padding:10px;">
     <table id="order-item-datagrid" class="easyui-datagrid" style="width:570px;height:450px;">
     	<thead>
     		<tr>
     			<th field="id">ID</th>
     			<th field="imageUrl" data-options="width:120">建材图片</th>
     			<th field="name" data-options="width:150">建材名称</th>
     			<th field="num" data-options="width:100">建材数量</th>
     			<th field="price" data-options="width:100">建材价格</th>
		...
		$('#view-dialog').dialog({
            ...
            onBeforeOpen:function(){
            	...
            	$('#order-item-datagrid').datagrid({
            		...
            		columns:[[
								{ field:'id',title:'ID'},
								{ field:'imageUrl',title:'建材主图',width:120,formatter:function(value,index,row){
									return '<img src = '+value+' width="120px">';
								}},
								{ field:'name',title:'建材名称',width:150},
								{ field:'price',title:'建材价格',width:100,sortable:true},
								{ field:'num',title:'建材数量',width:100,sortable:true},
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'productNum',title:'订单建材数',width:100,sortable:true},
