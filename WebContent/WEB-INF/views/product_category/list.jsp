	...
	<form id="add-form" method="post">
        <table>
            <tr>
                ...
                <td>
                    <select name="productId" class="easyui-combobox" panelHeight="auto" style="width:120px">
            	        <option value="-1">请选择所属父分类</option>
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'name',title:'建材分类名称',width:180,sortable:true},
