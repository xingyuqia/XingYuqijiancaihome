...
public class CartController {
	...
	public Map<String, String> add(Cart cart,HttpServletRequest request){
		...
		ret.put("type", "error");
		if(cart == null){
			ret.put("msg", "请选择正确的建材信息");
			return ret;
		}
		if(cart.getProductId() == null){
			ret.put("msg", "请选择要添加的建材！");
			return ret;
		}
		if(cart.getNum() == 0){
			ret.put("msg", "请填写建材数量");
		...
		if(existCart != null){
			...
			if(cartService.edit(existCart) <= 0){
				ret.put("msg", "建材已被添加到购物车，但更新数量出错!");
				return ret;
			}
